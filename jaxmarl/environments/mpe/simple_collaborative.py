...
Policy controls one agent
The other agent is using heuristics to get a fixed landmark
Two agents one landmark
Reward is higher if ego lets other landmark get to landmark first
Penalty for collision
"""


class SimpleCollaborativeMPE(SimpleMPE):
    def __init__(
        self,
        num_good_agents=1,
        num_adversaries=1,
